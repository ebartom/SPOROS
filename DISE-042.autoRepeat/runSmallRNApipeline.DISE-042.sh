...
#SBATCH -m a
#SBATCH --mem=50000
#SBATCH --chdir=/projects/b1069/DISE-042.autoRepeat
#SBATCH -o "%x.o%j"
...
project=DISE-042
workdir=/projects/b1069/DISE-042.autoRepeat
fastq=/projects/b1069/DISE-042.autoRepeat/fastq
currentDate=$(date +%F)
...
# Barcode files for demultiplexing found.  /projects/b1069/DISE-042.autoRepeat/HCT116_Drosha_Dicer_plus_HIV_rep_1_Jurkat_rep1_and_2_S1_R1_001.barcodes.txt /projects/b1069/DISE-042.autoRepeat/HCT116_Drosha_Dicer_plus_HIV_rep_2_J-Dro_3-11_rep1_and_2_S2_R1_001.barcodes.txt /projects/b1069/DISE-042.autoRepeat/HCT116_Drosha_Dicer_plus_HIV_rep_3_J-Dro_3-F6_rep1_and_2_S3_R1_001.barcodes.txt
...
Rscript $pipeline/runEdgeRrnaSeq.reads.R --countFile=$project.noAdapter.notUMId.rawCounts.relabeled.txt --numCores=24 --runMDS=0 --filterOff=0 --assembly=hg38.mp --comparisonFile=/projects/b1069/DISE-042.autoRepeat/comparisons.clean.csv
