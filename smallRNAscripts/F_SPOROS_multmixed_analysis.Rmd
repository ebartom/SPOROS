...
f.dicer <- "https://raw.githubusercontent.com/ebartom/SPOROS/main/Figure2.SPOROSpaper/totalCounts/F_seedExpand.DicerKO.avg.sRNA.Figure2.txt"
f.drosha <- "https://raw.githubusercontent.com/ebartom/SPOROS/main/Figure2.SPOROSpaper/totalCounts/F_seedExpand.DroshaKO.avg.sRNA.Figure2.txt"
f.wildtype <- "https://raw.githubusercontent.com/ebartom/SPOROS/main/Figure2.SPOROSpaper/totalCounts/F_seedExpand.Wildtype.avg.sRNA.Figure2.txt"
...
infile "G:\PeterM_XXX\Analysis\Data\MethodsPaper\data.seedLong.2021-07-01.csv" 
  dlm="," firstobs=2;
...
proc export data=work.sampleposdiffs
  outfile="G:\PeterM_XXX\Analysis\Data\MethodsPaper\F_OREstimates.xlsx"
  dbms=excel replace;
  sheet="OR Position";
run;
```
...
orest <- read_excel(paste(datapath, "F_OREstimates.xlsx", sep=""))
...
ggsave(paste(plotpath, "F_Dicer_OddsRatioPlot.pdf", sep=""),
...
# note: scaling may appear different in the PDF file due to specified height/width
ggsave(paste(plotpath, "F_Drosha_OddsRatioPlot.pdf", sep=""),
       width=11, height=8.5, units="in")
